...
def main():
    ...
    arg('run_root')
    arg('--model', default='seresnext101')
...
def train(args, model: nn.Module, criterion, *, params,
          ...
          n_epochs=None, patience=1, max_lr_changes=2) -> bool:
    lr = args.lr
    ...
    for epoch in range(epoch, n_epochs + 1):
        ...
        try:
            ...
            shutil.copy(str(model_path), str(model_save)+str(epoch)+'.pt')
